    ...
    pub fn vision3x3() {
        ...
        assert_eq!(
            ...
            [
                ...
                0.0, 0.5, 0.0, 0.0, 0.5, 0.0, 0.0, 0.5, 0.0, 0.0, 0.5, 0.0, 1.0, 0.5,
                0.0, // down-left, where the apple is relatively to the snake's head
    ...
    pub fn vision4x4() {
        ...
        assert_eq!(
            ...
            [
                ...
                0.0,
                1.0 / 3.0,
                0.0, // right, then counter-clockwise
                1.0,
                1.0 / 3.0,
                0.0,
                0.0,
